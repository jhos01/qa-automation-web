...
test.describe('Elements for Registration Form', () => {

  test('Validate Submit button is enabled', async ({ page }) => {
    ...
    await expect(submitButton, 'Submit button is enabled').toBeEnabled();
    page.close();
  });
